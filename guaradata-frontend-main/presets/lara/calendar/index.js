export default {
  ...
  input: ({ props }) => ({
    class: [
      ...
      // Colors
      "text-surface-600 dark:text-black",
  ...
  panel: ({ props }) => ({
    class: [
      ...
      // Colors
      "bg-surface-0 dark:bg-white",
      "border-surface-200 dark:bg-white",
  ...
  previousbutton: {
    class: [
      ...
      // States
      "hover:text-surface-700 dark:hover:text-black/80",
  ...
  weeknumber: {
    class: ["text-surface-600 dark:text-black", "opacity-60 cursor-default"],
  },
  weekday: {
    class: [
      // Colors
      "text-surface-500 dark:text-black/60",
    ],
  },
  day: {
    class: [
  ...
  weeklabelcontainer: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        "text-surface-600 dark:text-black bg-transparent":
  ...
  daylabel: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        ...
        "text-primary-700 bg-primary-100 dark:text-surface-black dark:bg-primary-300/40":
          context.selected && !context.disabled,
      },
  ...
  buttonbar: {
    class: [
      ...
      // Shape
      "border-t border-surface-200 dark:bg-white",
    ],
  },
  todaybutton: {
    root: {
