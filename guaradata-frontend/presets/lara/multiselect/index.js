export default {
  ...
  label: ({ props }) => ({
    class: [
      ...
      // Color
      {
        "text-surface-800 dark:text-black": props.modelValue,
  ...
  panel: {
    class: [
      ...
      // Color
      "bg-surface-0 dark:bg-white",
      "text-surface-800 dark:text-black",
  ...
  headerCheckbox: {
    ...
    box: ({ props, context }) => ({
      class: [
        ...
        // Colors
        {
          "border-surface-200 bg-surface-0 dark:border-surface-700 dark:bg-white":
            !context.checked,
  ...
  closeButton: {
    class: [
      ...
      // States
      "hover:text-surface-700 dark:hover:text-black",
      "hover:bg-surface-100 dark:hover:bg-white/80",
  ...
  item: ({ context }) => ({
    class: [
      ...
      {
        "bg-surface-200 dark:bg-surface-600/60 text-surface-700 dark:text-black":
          context.focused && !context.selected,
      },
      {
        "bg-primary-100 dark:bg-primary-400/40 text-primary-700 dark:text-black":
          context.focused && context.selected,
      },
      {
        "bg-primary-50 dark:bg-primary-400/40 text-primary-700 dark:text-black":
          !context.focused && context.selected,
      },

      // States
      {
        "hover:bg-surface-100 dark:hover:bg-white":
          !context.focused && !context.selected,
      },
      {
        "hover:text-surface-700 hover:bg-surface-100 dark:hover:text-black dark:hover:bg-white":
          context.focused && !context.selected,
      },
