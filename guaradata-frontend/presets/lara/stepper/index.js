  ...
  stepperpanel: {
    ...
    number: ({ context }) => ({
      class: [
        ...
        // Colors (Conditional)
        context.active
          ? "bg-primary-500 dark:bg-black text-black dark:text-white"
          : "border border-surface-200 dark:border-surface-700 text-white dark:text-black", // Adjust colors as needed
